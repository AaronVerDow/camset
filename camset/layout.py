...
class Layout:
    ...
    def setup_grid(self):
        ...
        self.win.main_box.pack_start(int_frame, False, False, 0)  # Changed from True, True to False, False
        ...
        self.win.main_box.pack_start(bool_frame, True, True, 0)  # Changed from False, False to True, True
